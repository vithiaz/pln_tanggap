import {
  ...
  export default function NotificationAlert() {
    ...
    const handleRedirect = () => {
        ...
        RNNotificationCall.answerCall('', JSON.stringify({name:'Test',Body:'test'}));
          ...
          <View style={styles.pageContainer}>
            ...
            <View style={styles.pageFooterWrapper}>
              <TouchableOpacity style={styles.footerButton}>
                <Text style={styles.footerButtonText} onPress={handleRedirect}>Saya Mengerti</Text>
              </TouchableOpacity>
            </View>
          </View>
        </SafeAreaView>
